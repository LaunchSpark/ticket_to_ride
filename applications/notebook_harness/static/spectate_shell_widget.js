...
Dispatch.prototype = dispatch.prototype = {
  ...
  call: function(type2, that) {
    ...
    for (t3 = this._[type2], i2 = 0, n2 = t3.length; i2 < n2; ++i2) t3[i2].value.apply(that, args);
  },
  apply: function(type2, that, args) {
    if (!this._.hasOwnProperty(type2)) throw new Error("unknown type: " + type2);
    for (var t3 = this._[type2], i2 = 0, n2 = t3.length; i2 < n2; ++i2) t3[i2].value.apply(that, args);
  }
};
...
function hslConvert(o2) {
  ...
  o2 = o2.rgb();
  var r2 = o2.r / 255, g2 = o2.g / 255, b2 = o2.b / 255, min4 = Math.min(r2, g2, b2), max4 = Math.max(r2, g2, b2), h2 = NaN, s2 = max4 - min4, l2 = (max4 + min4) / 2;
  if (s2) {
    if (r2 === max4) h2 = (g2 - b2) / s2 + (g2 < b2) * 6;
    else if (g2 === max4) h2 = (b2 - r2) / s2 + 2;
    else h2 = (r2 - g2) / s2 + 4;
...
function exponential(a3, b2, y4) {
  return a3 = Math.pow(a3, y4), b2 = Math.pow(b2, y4) - a3, y4 = 1 / y4, function(t3) {
    return Math.pow(a3 + t3 * b2, y4);
  };
}
function gamma(y4) {
  return (y4 = +y4) === 1 ? nogamma : function(a3, b2) {
    return b2 - a3 ? exponential(a3, b2, y4) : constant_default3(isNaN(a3) ? b2 : a3);
  };
}
...
function numberArray_default(a3, b2) {
  ...
  return function(t3) {
    for (i2 = 0; i2 < n2; ++i2) c3[i2] = a3[i2] * (1 - t3) + b2[i2] * t3;
    return c3;
  };
}
...
function genericArray(a3, b2) {
  var nb = b2 ? b2.length : 0, na = a3 ? Math.min(nb, a3.length) : 0, x4 = new Array(na), c3 = new Array(nb), i2;
  for (i2 = 0; i2 < na; ++i2) x4[i2] = value_default(a3[i2], b2[i2]);
  for (; i2 < nb; ++i2) c3[i2] = b2[i2];
  return function(t3) {
    for (i2 = 0; i2 < na; ++i2) c3[i2] = x4[i2](t3);
    return c3;
  };
}
...
function date_default(a3, b2) {
  ...
  return a3 = +a3, b2 = +b2, function(t3) {
    return d2.setTime(a3 * (1 - t3) + b2 * t3), d2;
  };
}
...
function value_default(a3, b2) {
  var t3 = typeof b2, c3;
  return b2 == null || t3 === "boolean" ? constant_default3(b2) : (t3 === "number" ? number_default : t3 === "string" ? (c3 = color(b2)) ? (b2 = c3, rgb_default) : string_default : b2 instanceof color ? rgb_default : b2 instanceof Date ? date_default : isNumberArray(b2) ? numberArray_default : Array.isArray(b2) ? genericArray : typeof b2.valueOf !== "function" && typeof b2.toString !== "function" || isNaN(b2) ? object_default : number_default)(a3, b2);
}

// node_modules/d3-interpolate/src/round.js
function round_default(a3, b2) {
  return a3 = +a3, b2 = +b2, function(t3) {
    return Math.round(a3 * (1 - t3) + b2 * t3);
  };
}
...
function interpolateTransform(parse, pxComma, pxParen, degParen) {
  ...
  return function(a3, b2) {
    ...
    return function(t3) {
      ...
      while (++i2 < n2) s2[(o2 = q2[i2]).i] = o2.x(t3);
      return s2.join("");
    };
  };
}
...
function zoom_default2() {
  ...
  zoom2.scaleTo = function(selection2, k2, p2, event) {
    zoom2.transform(selection2, function() {
      var e3 = extent2.apply(this, arguments), t0 = this.__zoom, p0 = p2 == null ? centroid(e3) : typeof p2 === "function" ? p2.apply(this, arguments) : p2, p1 = t0.invert(p0), k1 = typeof k2 === "function" ? k2.apply(this, arguments) : k2;
  ...
  zoom2.translateTo = function(selection2, x4, y4, p2, event) {
    zoom2.transform(selection2, function() {
      var e3 = extent2.apply(this, arguments), t3 = this.__zoom, p0 = p2 == null ? centroid(e3) : typeof p2 === "function" ? p2.apply(this, arguments) : p2;
...
function bisector(f2) {
  ...
  if (f2.length !== 2) {
    compare1 = ascending2;
    compare2 = (d2, x4) => ascending2(f2(d2), x4);
...
function min(values, valueof) {
  ...
  if (valueof === void 0) {
    ...
    let index7 = -1;
    for (let value of values) {
      if ((value = valueof(value, ++index7, values)) != null && (min4 > value || min4 === void 0 && value >= value)) {
        min4 = value;
      }
    }
  }
...
function _iterableToArrayLimit(r2, l2) {
  ...
  if (null != t3) {
    ...
    try {
      ...
      else for (; !(f2 = (e3 = i2.call(t3)).done) && (a3.push(e3.value), a3.length !== l2); f2 = true) ;
    } catch (r3) {
      o2 = true, n2 = r3;
    } finally {
      try {
...
function rgbToHsl(r2, g2, b2) {
  ...
  g2 = bound01(g2, 255);
  b2 = bound01(b2, 255);
  var max4 = Math.max(r2, g2, b2), min4 = Math.min(r2, g2, b2);
...
function _classPrivateFieldInitSpec(e3, t3, a3) {
  _checkPrivateRedeclaration(e3, t3), t3.set(e3, a3);
}
...
function _createClass2(e3, r2, t3) {
...
function k(l2, u2, t3) {
  ...
  if (arguments.length > 2 && (e3.children = arguments.length > 3 ? n.call(arguments, 2) : t3), "function" == typeof l2 && null != l2.defaultProps) for (o2 in l2.defaultProps) void 0 === e3[o2] && (e3[o2] = l2.defaultProps[o2]);
  return x(l2, e3, i2, r2, null);
}
function x(n2, t3, i2, r2, o2) {
  var e3 = { type: n2, props: t3, key: i2, ref: r2, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: null == o2 ? ++u : o2, __i: -1, __u: 0 };
...
function L(n2, l2, u2, t3, i2, r2, o2, e3, f2, c3, a3) {
  var s2, h2, p2, v2, y4, _2, g2, m3 = t3 && t3.__k || w, b2 = l2.length;
  for (f2 = T(u2, l2, m3, f2, b2), s2 = 0; s2 < b2; s2++) null != (p2 = u2.__k[s2]) && (h2 = -1 != p2.__i && m3[p2.__i] || d, p2.__i = s2, _2 = q(n2, p2, h2, i2, r2, o2, e3, f2, c3, a3), v2 = p2.__e, p2.ref && h2.ref != p2.ref && (h2.ref && J(h2.ref, null, p2), a3.push(p2.ref, p2.__c || v2, p2)), null == y4 && null != v2 && (y4 = v2), (g2 = !!(4 & p2.__u)) || h2.__k === p2.__k ? (f2 = j(p2, f2, n2, g2), g2 && h2.__e && (h2.__e = null)) : "function" == typeof p2.type && void 0 !== _2 ? f2 = _2 : v2 && (f2 = v2.nextSibling), p2.__u &= -7);
  return u2.__e = y4, f2;
}
function T(n2, l2, u2, t3, i2) {
  var r2, o2, e3, f2, c3, a3 = u2.length, s2 = a3, h2 = 0;
  for (n2.__k = new Array(i2), r2 = 0; r2 < i2; r2++) null != (o2 = l2[r2]) && "boolean" != typeof o2 && "function" != typeof o2 ? ("string" == typeof o2 || "number" == typeof o2 || "bigint" == typeof o2 || o2.constructor == String ? o2 = n2.__k[r2] = x(null, o2, null, null, null) : g(o2) ? o2 = n2.__k[r2] = x(S, { children: o2 }, null, null, null) : void 0 === o2.constructor && o2.__b > 0 ? o2 = n2.__k[r2] = x(o2.type, o2.props, o2.key, o2.ref ? o2.ref : null, o2.__v) : n2.__k[r2] = o2, f2 = r2 + h2, o2.__ = n2, o2.__b = n2.__b + 1, e3 = null, -1 != (c3 = o2.__i = O(o2, u2, f2, s2)) && (s2--, (e3 = u2[c3]) && (e3.__u |= 2)), null == e3 || null == e3.__v ? (-1 == c3 && (i2 > a3 ? h2-- : i2 < a3 && h2++), "function" != typeof o2.type && (o2.__u |= 4)) : c3 != f2 && (c3 == f2 - 1 ? h2-- : c3 == f2 + 1 ? h2++ : (c3 > f2 ? h2-- : h2++, o2.__u |= 4))) : n2.__k[r2] = null;
  if (s2) for (r2 = 0; r2 < a3; r2++) null != (e3 = u2[r2]) && 0 == (2 & e3.__u) && (e3.__e == t3 && (t3 = $(e3)), K(e3, e3));
  return t3;
}
...
function O(n2, l2, u2, t3) {
  var i2, r2, o2, e3 = n2.key, f2 = n2.type, c3 = l2[u2], a3 = null != c3 && 0 == (2 & c3.__u);
  if (null === c3 && null == e3 || a3 && e3 == c3.key && f2 == c3.type) return u2;
  if (t3 > (a3 ? 1 : 0)) {
    for (i2 = u2 - 1, r2 = u2 + 1; i2 >= 0 || r2 < l2.length; ) if (null != (c3 = l2[o2 = i2 >= 0 ? i2-- : r2++]) && 0 == (2 & c3.__u) && e3 == c3.key && f2 == c3.type) return o2;
  }
  return -1;
}
function z(n2, l2, u2) {
...
function q(n2, u2, t3, i2, r2, o2, e3, f2, c3, a3) {
  var s2, h2, p2, v2, y4, d2, _2, k2, x4, M, $2, I2, P2, A2, H2, T2, j2 = u2.type;
  if (void 0 !== u2.constructor) return null;
  128 & t3.__u && (c3 = !!(32 & t3.__u), o2 = [f2 = u2.__e = t3.__e]), (s2 = l.__b) && s2(u2);
  n: if ("function" == typeof j2) {
    h2 = e3.length;
    try {
      if (x4 = u2.props, M = j2.prototype && j2.prototype.render, $2 = (s2 = j2.contextType) && i2[s2.__c], I2 = s2 ? $2 ? $2.props.value : s2.__ : i2, t3.__c ? k2 = (p2 = u2.__c = t3.__c).__ = p2.__E : (M ? u2.__c = p2 = new j2(x4, I2) : (u2.__c = p2 = new C(x4, I2), p2.constructor = j2, p2.render = Q), $2 && $2.sub(p2), p2.state || (p2.state = {}), p2.__n = i2, v2 = p2.__d = true, p2.__h = [], p2._sb = []), M && null == p2.__s && (p2.__s = p2.state), M && null != j2.getDerivedStateFromProps && (p2.__s == p2.state && (p2.__s = m({}, p2.__s)), m(p2.__s, j2.getDerivedStateFromProps(x4, p2.__s))), y4 = p2.props, d2 = p2.state, p2.__v = u2, v2) M && null == j2.getDerivedStateFromProps && null != p2.componentWillMount && p2.componentWillMount(), M && null != p2.componentDidMount && p2.__h.push(p2.componentDidMount);
      else {
        if (M && null == j2.getDerivedStateFromProps && x4 !== y4 && null != p2.componentWillReceiveProps && p2.componentWillReceiveProps(x4, I2), u2.__v == t3.__v || !p2.__e && null != p2.shouldComponentUpdate && false === p2.shouldComponentUpdate(x4, p2.__s, I2)) {
          u2.__v != t3.__v && (p2.props = x4, p2.state = p2.__s, p2.__d = false), u2.__e = t3.__e, u2.__k = t3.__k, u2.__k.some(function(n3) {
            n3 && (n3.__ = u2);
          }), w.push.apply(p2.__h, p2._sb), p2._sb = [], p2.__h.length && e3.push(p2);
          break n;
        }
        null != p2.componentWillUpdate && p2.componentWillUpdate(x4, p2.__s, I2), M && null != p2.componentDidUpdate && p2.__h.push(function() {
          p2.componentDidUpdate(y4, d2, _2);
        });
      }
      if (p2.context = I2, p2.props = x4, p2.__P = n2, p2.__e = false, P2 = l.__r, A2 = 0, M) p2.state = p2.__s, p2.__d = false, P2 && P2(u2), s2 = p2.render(p2.props, p2.state, p2.context), w.push.apply(p2.__h, p2._sb), p2._sb = [];
      else do {
        p2.__d = false, P2 && P2(u2), s2 = p2.render(p2.props, p2.state, p2.context), p2.state = p2.__s;
      } while (p2.__d && ++A2 < 25);
      p2.state = p2.__s, null != p2.getChildContext && (i2 = m(m({}, i2), p2.getChildContext())), M && !v2 && null != p2.getSnapshotBeforeUpdate && (_2 = p2.getSnapshotBeforeUpdate(y4, d2)), H2 = null != s2 && s2.type === S && null == s2.key ? E(s2.props.children) : s2, f2 = L(n2, g(H2) ? H2 : [H2], u2, t3, i2, r2, o2, e3, f2, c3, a3), p2.base = u2.__e, u2.__u &= -161, p2.__h.length && e3.push(p2), k2 && (p2.__E = p2.__ = null);
    } catch (n3) {
      if (e3.length = h2, u2.__v = null, c3 || null != o2) if (n3.then) {
      ...
      else u2.__e = t3.__e, !u2.__k && t3.__k && (u2.__k = t3.__k), n3.then || B(u2);
      l.__e(n3, u2, t3);
    }
  } else null == o2 && u2.__v == t3.__v ? (u2.__k = t3.__k, u2.__e = t3.__e) : f2 = u2.__e = G(t3.__e, u2, t3, i2, r2, o2, e3, c3, a3);
...
function G(u2, t3, i2, r2, o2, e3, f2, c3, a3) {
  var s2, h2, p2, v2, y4, w2, _2, m3 = i2.props || d, k2 = t3.props, x4 = t3.type;
  if ("svg" == x4 ? o2 = "http://www.w3.org/2000/svg" : "math" == x4 ? o2 = "http://www.w3.org/1998/Math/MathML" : o2 || (o2 = "http://www.w3.org/1999/xhtml"), null != e3) {
    for (s2 = 0; s2 < e3.length; s2++) if ((y4 = e3[s2]) && "setAttribute" in y4 == !!x4 && (x4 ? y4.localName == x4 : 3 == y4.nodeType)) {
      u2 = y4, e3[s2] = null;
      break;
    }
  }
  if (null == u2) {
    ...
    u2 = document.createElementNS(o2, x4, k2.is && k2), c3 && (l.__m && l.__m(t3, e3), c3 = false), e3 = null;
  }
  if (null == x4) m3 === k2 || c3 && u2.data == k2 || (u2.data = k2);
  else {
    if (e3 = "textarea" == x4 && null != k2.defaultValue ? null : e3 && n.call(u2.childNodes), !c3 && null != e3) for (m3 = {}, s2 = 0; s2 < u2.attributes.length; s2++) m3[(y4 = u2.attributes[s2]).name] = y4.value;
    for (s2 in m3) y4 = m3[s2], "dangerouslySetInnerHTML" == s2 ? p2 = y4 : "children" == s2 || s2 in k2 || "value" == s2 && "defaultValue" in k2 || "checked" == s2 && "defaultChecked" in k2 || N(u2, s2, null, y4, o2);
    for (s2 in k2) y4 = k2[s2], "children" == s2 ? v2 = y4 : "dangerouslySetInnerHTML" == s2 ? h2 = y4 : "value" == s2 ? w2 = y4 : "checked" == s2 ? _2 = y4 : c3 && "function" != typeof y4 || m3[s2] === y4 || N(u2, s2, y4, m3[s2], o2);
    if (h2) c3 || p2 && (h2.__html == p2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t3.__k = [];
    else if (p2 && (u2.innerHTML = ""), L("template" == t3.type ? u2.content : u2, g(v2) ? v2 : [v2], t3, i2, r2, "foreignObject" == x4 ? "http://www.w3.org/1999/xhtml" : o2, e3, f2, e3 ? e3[0] : i2.__k && $(i2, 0), c3, a3), null != e3) for (s2 = e3.length; s2--; ) b(e3[s2]);
    c3 && "textarea" != x4 || (s2 = "value", "progress" == x4 && null == w2 ? u2.removeAttribute("value") : null != w2 && (w2 !== u2[s2] || "progress" == x4 && !w2 || "option" == x4 && w2 != m3[s2]) && N(u2, s2, w2, m3[s2], o2), s2 = "checked", null != _2 && _2 != u2[s2] && N(u2, s2, _2, m3[s2], o2));
  }
  return u2;
}
function J(n2, u2, t3) {
...
function R(u2, t3, i2) {
  var r2, o2, e3, f2;
  t3 == document && (t3 = document.documentElement), l.__ && l.__(u2, t3), o2 = (r2 = "function" == typeof i2) ? null : i2 && i2.__k || t3.__k, e3 = [], f2 = [], q(t3, u2 = (!r2 && i2 || t3).__k = k(S, null, [u2]), o2 || d, d, t3.namespaceURI, !r2 && i2 ? [i2] : o2 ? null : t3.firstChild ? n.call(t3.childNodes) : null, e3, !r2 && i2 ? i2 : o2 ? o2.__e : t3.firstChild, r2, f2), D(e3, u2, f2), u2.props.children = null;
}
function W(l2, u2, t3) {
...
function _slicedToArray2(r2, e3) {
  return _arrayWithHoles2(r2) || _iterableToArrayLimit2(r2, e3) || _unsupportedIterableToArray3(r2, e3) || _nonIterableRest2();
}
...
function center_default(x4, y4, z3) {
  ...
  function force() {
    ...
    for (sx = (sx / n2 - x4) * strength, sy = (sy / n2 - y4) * strength, sz = (sz / n2 - z3) * strength, i2 = 0; i2 < n2; ++i2) {
      node = nodes[i2];
      if (sx) {
        node.x -= sx;
      }
...
function find_default(x4, radius) {
  ...
  while (q2 = halves.pop()) {
    ...
    if (node.length) {
      ...
      var d2 = Math.abs(x4 - +this._x.call(null, node.data));
      if (d2 < radius) {
        radius = d2;
        x0 = x4 - d2;
        x32 = x4 + d2;
...
function remove_default3(d2) {
  if (isNaN(x4 = +this._x.call(null, d2))) return this;
...
treeProto2.copy = function() {
  ...
  if (!node) return copy2;
  if (!node.length) return copy2._root = leaf_copy2(node), copy2;
...
function addAll3(data) {
  ...
  for (let i2 = 0, d2, x4, y4, z3; i2 < n2; ++i2) {
    if (isNaN(x4 = +this._x.call(null, d2 = data[i2])) || isNaN(y4 = +this._y.call(null, d2)) || isNaN(z3 = +this._z.call(null, d2))) continue;
    xz[i2] = x4;
    yz[i2] = y4;
    zz[i2] = z3;
    if (x4 < x0) x0 = x4;
...
function cover_default3(x4, y4, z3) {
  if (isNaN(x4 = +x4) || isNaN(y4 = +y4) || isNaN(z3 = +z3)) return this;
  ...
  if (isNaN(x0)) {
    ...
    while (x0 > x4 || x4 >= x1 || y0 > y4 || y4 >= y1 || z0 > z3 || z3 >= z1) {
      i2 = (z3 < z0) << 2 | (y4 < y0) << 1 | x4 < x0;
...
function find_default3(x4, y4, z3, radius) {
  ...
  if (radius == null) radius = Infinity;
    ...
    x0 = x4 - radius, y0 = y4 - radius, z0 = z3 - radius;
    x32 = x4 + radius, y32 = y4 + radius, z32 = z3 + radius;
    radius *= radius;
  }
  while (q2 = octs.pop()) {
    ...
    if (node.length) {
      ...
      if (i2 = (z3 >= zm) << 2 | (y4 >= ym) << 1 | x4 >= xm) {
        q2 = octs[octs.length - 1];
        octs[octs.length - 1] = octs[octs.length - 1 - i2];
        octs[octs.length - 1 - i2] = q2;
      }
    } else {
      var dx = x4 - +this._x.call(null, node.data), dy = y4 - +this._y.call(null, node.data), dz = z3 - +this._z.call(null, node.data), d2 = dx * dx + dy * dy + dz * dz;
      if (d2 < radius) {
        var d3 = Math.sqrt(radius = d2);
        x0 = x4 - d3, y0 = y4 - d3, z0 = z3 - d3;
        x32 = x4 + d3, y32 = y4 + d3, z32 = z3 + d3;
        data = node.data;
      }
    }
  }
...
function findAllWithinRadius(x4, y4, z3, radius) {
  const result = [];
  ...
  this.visit((node, x1, y1, z1, x22, y22, z22) => {
    if (!node.length) {
      do {
        const d2 = node.data;
        if (distance(x4, y4, z3, this._x(d2), this._y(d2), this._z(d2)) <= radius) {
          result.push(d2);
        }
      } while (node = node.next);
    }
...
function remove_default5(d2) {
  if (isNaN(x4 = +this._x.call(null, d2)) || isNaN(y4 = +this._y.call(null, d2)) || isNaN(z3 = +this._z.call(null, d2))) return this;
  var parent, node = this._root, retainer, previous, next, x0 = this._x0, y0 = this._y0, z0 = this._z0, x1 = this._x1, y1 = this._y1, z1 = this._z1, x4, y4, z3, xm, ym, zm, right, bottom, deep, i2, j2;
  if (!node) return this;
  if (node.length) while (true) {
    if (right = x4 >= (xm = (x0 + x1) / 2)) x0 = xm;
    else x1 = xm;
...
treeProto3.copy = function() {
  ...
  if (!node) return copy2;
  if (!node.length) return copy2._root = leaf_copy3(node), copy2;
...
function link_default(links) {
  ...
  function force(alpha) {
    for (var k2 = 0, n2 = links.length; k2 < iterations; ++k2) {
      for (var i2 = 0, link, source, target, x4 = 0, y4 = 0, z3 = 0, l2, b2; i2 < n2; ++i2) {
        ...
        l2 = Math.sqrt(x4 * x4 + y4 * y4 + z3 * z3);
...
function simulation_default(nodes, numDimensions) {
  ...
  return simulation = {
    ...
    find: function() {
      ...
      var x4 = args.shift() || 0, y4 = (nDim > 1 ? args.shift() : null) || 0, z3 = (nDim > 2 ? args.shift() : null) || 0, radius = args.shift() || Infinity;
...
function manyBody_default() {
  ...
  function accumulate(treeNode) {
    var strength2 = 0, q2, c3, weight = 0, x4, y4, z3, i2;
    var numChildren = treeNode.length;
    if (numChildren) {
      for (x4 = y4 = z3 = i2 = 0; i2 < numChildren; ++i2) {
        if ((q2 = treeNode[i2]) && (c3 = Math.abs(q2.value))) {
          strength2 += q2.value, weight += c3, x4 += c3 * (q2.x || 0), y4 += c3 * (q2.y || 0), z3 += c3 * (q2.z || 0);
        }
      }
      strength2 *= Math.sqrt(4 / numChildren);
      treeNode.x = x4 / weight;
      if (nDim > 1) {
        treeNode.y = y4 / weight;
      }
      if (nDim > 2) {
  ...
  function apply(treeNode, x1, arg1, arg2, arg3) {
    ...
    var x4 = treeNode.x - node.x, y4 = nDim > 1 ? treeNode.y - node.y : 0, z3 = nDim > 2 ? treeNode.z - node.z : 0, w2 = x22 - x1, l2 = x4 * x4 + y4 * y4 + z3 * z3;
    if (w2 * w2 / theta2 < l2) {
      if (l2 < distanceMax2) {
        if (x4 === 0) x4 = jiggle_default(random), l2 += x4 * x4;
        if (nDim > 1 && y4 === 0) y4 = jiggle_default(random), l2 += y4 * y4;
        if (nDim > 2 && z3 === 0) z3 = jiggle_default(random), l2 += z3 * z3;
        if (l2 < distanceMin2) l2 = Math.sqrt(distanceMin2 * l2);
        node.vx += x4 * treeNode.value * alpha / l2;
        if (nDim > 1) {
          node.vy += y4 * treeNode.value * alpha / l2;
        }
        if (nDim > 2) {
...
function radial_default(radius, x4, y4, z3) {
  ...
  function force(alpha) {
    for (var i2 = 0, n2 = nodes.length; i2 < n2; ++i2) {
      var node = nodes[i2], dx = node.x - x4 || 1e-6, dy = (node.y || 0) - y4 || 1e-6, dz = (node.z || 0) - z3 || 1e-6, r2 = Math.sqrt(dx * dx + dy * dy + dz * dz), k2 = (radiuses[i2] - r2) * strengths[i2] * alpha / r2;
      node.vx += dx * k2;
      if (nDim > 1) {
        node.vy += dy * k2;
      }
...
var utils = {
  ...
  lli8: function(x1, y1, x22, y22, x32, y32, x4, y4) {
    const nx = (x1 * y22 - y1 * x22) * (x32 - x4) - (x1 - x22) * (x32 * y4 - y32 * x4), ny = (x1 * y22 - y1 * x22) * (y32 - y4) - (y1 - y22) * (x32 * y4 - y32 * x4), d2 = (x1 - x22) * (y32 - y4) - (y1 - y22) * (x32 - x4);
    if (d2 == 0) {
      return false;
    }
  ...
  lli4: function(p1, p2, p3, p4) {
    const x1 = p1.x, y1 = p1.y, x22 = p2.x, y22 = p2.y, x32 = p3.x, y32 = p3.y, x4 = p4.x, y4 = p4.y;
    return utils.lli8(x1, y1, x22, y22, x32, y32, x4, y4);
  },
  lli: function(v1, v2) {
...
var Bezier = class _Bezier {
  ...
  static cubicFromPoints(S2, B2, E2, t3, d1) {
    ...
    const e1 = { x: B2.x - bx1, y: B2.y - by1 }, e22 = { x: B2.x + bx2, y: B2.y + by2 }, A2 = abc.A, v1 = { x: A2.x + (e1.x - A2.x) / (1 - t3), y: A2.y + (e1.y - A2.y) / (1 - t3) }, v2 = { x: A2.x + (e22.x - A2.x) / t3, y: A2.y + (e22.y - A2.y) / t3 }, nc1 = { x: S2.x + (v1.x - S2.x) / t3, y: S2.y + (v1.y - S2.y) / t3 }, nc2 = {
  ...
  toSVG() {
    ...
    const p2 = this.points, x4 = p2[0].x, y4 = p2[0].y, s2 = ["M", x4, y4, this.order === 2 ? "Q" : "C"];
...
function _objectWithoutProperties(e3, t3) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (r2 = 0; r2 < s2.length; r2++) o2 = s2[r2], t3.includes(o2) || {}.propertyIsEnumerable.call(e3, o2) && (i2[o2] = e3[o2]);
  }
  return i2;
}
...
function _slicedToArray3(r2, e3) {
  return _arrayWithHoles3(r2) || _iterableToArrayLimit3(r2, e3) || _unsupportedIterableToArray4(r2, e3) || _nonIterableRest3();
}
...
function polymap(domain, range, interpolate) {
  ...
  return function(x4) {
    var i3 = bisect_default(domain, x4, 1, j2) - 1;
    return r2[i3](d2[i3](x4));
  };
}
...
function transformer() {
  ...
  function rescale() {
    ...
    if (clamp !== identity3) clamp = clamper(domain[0], domain[n2 - 1]);
  ...
  scale.invert = function(y4) {
    return clamp(untransform((input || (input = piecewise(range, domain.map(transform2), number_default)))(y4)));
  };
  scale.domain = function(_2) {
...
function formatDecimalParts(x4, p2) {
  ...
  var i2 = (x4 = p2 ? x4.toExponential(p2 - 1) : x4.toExponential()).indexOf("e"), coefficient = x4.slice(0, i2);
  return [
...
function formatGroup_default(grouping, thousands) {
  return function(value, width) {
    var i2 = value.length, t3 = [], j2 = 0, g2 = grouping[0], length = 0;
    while (i2 > 0 && g2 > 0) {
      if (length + g2 + 1 > width) g2 = Math.max(1, width - length);
      t3.push(value.substring(i2 -= g2, i2 + g2));
...
function formatPrefixAuto_default(x4, p2) {
  ...
  if (!d2) return prefixExponent = void 0, x4.toPrecision(p2);
  ...
  return i2 === n2 ? coefficient : i2 > n2 ? coefficient + new Array(i2 - n2 + 1).join("0") : i2 > 0 ? coefficient.slice(0, i2) + "." + coefficient.slice(i2) : "0." + new Array(1 - i2).join("0") + formatDecimalParts(x4, Math.max(0, p2 + i2 - 1))[0];
}
...
function _defineProperty2(e3, r2, t3) {
...
var forceGraph = index({
  ...
  methods: _objectSpread22({
    graph2ScreenCoords: function graph2ScreenCoords(state, x4, y4) {
    ...
    screen2GraphCoords: function screen2GraphCoords(state, x4, y4) {
      var t3 = transform(state.canvas);
      return {
        x: (x4 - t3.x) / t3.k,
        y: (y4 - t3.y) / t3.k
    ...
    centerAt: function centerAt(state, x4, y4, transitionDuration) {
      if (!state.canvas) return null;
      if (x4 !== void 0 || y4 !== void 0) {
        var finalPos = Object.assign({}, x4 !== void 0 ? {
          x: x4
        } : {}, y4 !== void 0 ? {
          y: y4
        } : {});
      ...
      function setCenter(_ref5) {
        var x5 = _ref5.x, y5 = _ref5.y;
        state.zoom.translateTo(state.zoom.__baseElem, x5 === void 0 ? getCenter().x : x5, y5 === void 0 ? getCenter().y : y5);
        state.needsRedraw = true;
      }
    },
...
function brush(dim) {
  var extent2 = defaultExtent2, filter2 = defaultFilter3, touchable = defaultTouchable3, keys = true, listeners = dispatch_default2("start", "brush", "end"), handleSize = 6, touchending;
  ...
  brush2.move = function(group, selection2, event) {
    if (group.tween) {
      group.on("start.brush", function(event2) {
        ...
        function tween(t3) {
          state.selection = t3 === 1 && selection1 === null ? null : i2(t3);
          redraw.call(that);
          emit.brush();
        }
  ...
  function started(event) {
    ...
    if (!filter2.apply(this, arguments)) return;
    var that = this, type2 = event.target.__data__.type, mode = (keys && event.metaKey ? type2 = "overlay" : type2) === "selection" ? MODE_DRAG : keys && event.altKey ? MODE_CENTER : MODE_HANDLE, signX = dim === Y ? null : signsX[type2], signY = dim === X ? null : signsY[type2], state = local(that), extent3 = state.extent, selection2 = state.selection, W2 = extent3[0][0], w0, w1, N2 = extent3[0][1], n0, n1, E2 = extent3[1][0], e0, e1, S2 = extent3[1][1], s0, s1, dx = 0, dy = 0, moving, shifting = signX && signY && keys && event.shiftKey, lockX, lockY, points = Array.from(event.touches || [event], (t3) => {
      const i2 = t3.identifier;
    ...
    if (type2 === "overlay") {
      ...
      state.selection = selection2 = [[
        w0 = dim === Y ? W2 : min3(pts[0][0], pts[1][0]),
        n0 = dim === X ? N2 : min3(pts[0][1], pts[1][1])
      ], [
        e0 = dim === Y ? E2 : max3(pts[0][0], pts[1][0]),
        s0 = dim === X ? S2 : max3(pts[0][1], pts[1][1])
      ]];
    ...
    function moved(event2) {
      for (const p2 of event2.changedTouches || [event2]) {
        for (const d2 of points)
          if (d2.identifier === p2.identifier) d2.cur = pointer_default(p2, that);
      }
      if (shifting && !lockX && !lockY && points.length === 1) {
        const point = points[0];
        if (abs3(point.cur[0] - point[0]) > abs3(point.cur[1] - point[1]))
          lockY = true;
        else
          lockX = true;
      }
    ...
    function move(event2) {
      ...
      switch (mode) {
        case MODE_SPACE:
        case MODE_DRAG: {
          if (signX) dx = max3(W2 - w0, min3(E2 - e0, dx)), w1 = w0 + dx, e1 = e0 + dx;
          if (signY) dy = max3(N2 - n0, min3(S2 - s0, dy)), n1 = n0 + dy, s1 = s0 + dy;
          break;
        }
        case MODE_HANDLE: {
          if (points[1]) {
            if (signX) w1 = max3(W2, min3(E2, points[0][0])), e1 = max3(W2, min3(E2, points[1][0])), signX = 1;
            if (signY) n1 = max3(N2, min3(S2, points[0][1])), s1 = max3(N2, min3(S2, points[1][1])), signY = 1;
          } else {
            if (signX < 0) dx = max3(W2 - w0, min3(E2 - w0, dx)), w1 = w0 + dx, e1 = e0;
            else if (signX > 0) dx = max3(W2 - e0, min3(E2 - e0, dx)), w1 = w0, e1 = e0 + dx;
            if (signY < 0) dy = max3(N2 - n0, min3(S2 - n0, dy)), n1 = n0 + dy, s1 = s0;
            else if (signY > 0) dy = max3(N2 - s0, min3(S2 - s0, dy)), n1 = n0, s1 = s0 + dy;
          }
          break;
        }
        case MODE_CENTER: {
          if (signX) w1 = max3(W2, min3(E2, w0 - dx * signX)), e1 = max3(W2, min3(E2, e0 + dx * signX));
          if (signY) n1 = max3(N2, min3(S2, n0 - dy * signY)), s1 = max3(N2, min3(S2, s0 + dy * signY));
          break;
        }
      }
      if (e1 < w1) {
  ...
  brush2.extent = function(_2) {
    return arguments.length ? (extent2 = typeof _2 === "function" ? _2 : constant_default6(number22(_2)), brush2) : extent2;
  };
  brush2.filter = function(_2) {
    return arguments.length ? (filter2 = typeof _2 === "function" ? _2 : constant_default6(!!_2), brush2) : filter2;
  };
  brush2.touchable = function(_2) {
    return arguments.length ? (touchable = typeof _2 === "function" ? _2 : constant_default6(!!_2), brush2) : touchable;
  };
...
function link_default2(links) {
  var id2 = index6, strength = defaultStrength, strengths, distance2 = constant_default7(30), distances, nodes, count, bias, random, iterations = 1;
  if (links == null) links = [];
  function defaultStrength(link) {
    return 1 / Math.min(count[link.source.index], count[link.target.index]);
  }
  function force(alpha) {
    for (var k2 = 0, n2 = links.length; k2 < iterations; ++k2) {
      for (var i2 = 0, link, source, target, x4, y4, l2, b2; i2 < n2; ++i2) {
        link = links[i2], source = link.source, target = link.target;
        x4 = target.x + target.vx - source.x - source.vx || jiggle_default2(random);
        y4 = target.y + target.vy - source.y - source.vy || jiggle_default2(random);
  ...
  force.strength = function(_2) {
    return arguments.length ? (strength = typeof _2 === "function" ? _2 : constant_default7(+_2), initializeStrength(), force) : strength;
  };
  force.distance = function(_2) {
    return arguments.length ? (distance2 = typeof _2 === "function" ? _2 : constant_default7(+_2), initializeDistance(), force) : distance2;
  };
  return force;
}
...
function manyBody_default2() {
  ...
  function apply(quad, x1, _2, x22) {
    ...
    if (w2 * w2 / theta2 < l2) {
      if (l2 < distanceMax2) {
        if (x4 === 0) x4 = jiggle_default2(random), l2 += x4 * x4;
        if (y4 === 0) y4 = jiggle_default2(random), l2 += y4 * y4;
        if (l2 < distanceMin2) l2 = Math.sqrt(distanceMin2 * l2);
  ...
  force.strength = function(_2) {
    return arguments.length ? (strength = typeof _2 === "function" ? _2 : constant_default7(+_2), initialize(), force) : strength;
  };
  force.distanceMin = function(_2) {
    return arguments.length ? (distanceMin2 = _2 * _2, force) : Math.sqrt(distanceMin2);
  };
...
function quickselect(arr, k2, left = 0, right = arr.length - 1, compare = defaultCompare) {
  while (right > left) {
    if (right - left > 600) {
      ...
      const sd = 0.5 * Math.sqrt(z3 * s2 * (n2 - s2) / n2) * (m3 - n2 / 2 < 0 ? -1 : 1);
      const newLeft = Math.max(left, Math.floor(k2 - m3 * s2 / n2 + sd));
      const newRight = Math.min(right, Math.floor(k2 + (n2 - m3) * s2 / n2 + sd));
    ...
    let j2 = right;
    swap(arr, left, k2);
    if (compare(arr[right], t3) > 0) swap(arr, left, right);
    while (i2 < j2) {
      swap(arr, i2, j2);
      i2++;
      j2--;
      while (compare(arr[i2], t3) < 0) i2++;
      while (compare(arr[j2], t3) > 0) j2--;
    }
    if (compare(arr[left], t3) === 0) swap(arr, left, j2);
    else {
      j2++;
      swap(arr, j2, right);
    }
...
var RBush = class {
  ...
  remove(item, equalsFn) {
    ...
    while (node || path.length) {
      ...
      if (node.leaf) {
        const index7 = findItem(item, node.children, equalsFn);
        if (index7 !== -1) {
          node.children.splice(index7, 1);
          path.push(node);
          this._condense(path);
          return this;
        }
  ...
  _split(insertPath, level) {
    ...
    const m3 = this._minEntries;
    this._chooseSplitAxis(node, m3, M);
    const splitIndex = this._chooseSplitIndex(node, m3, M);
  ...
  _chooseSplitIndex(node, m3, M) {
    let index7;
    let minOverlap = Infinity;
    let minArea = Infinity;
    for (let i2 = m3; i2 <= M - m3; i2++) {
  ...
  _chooseSplitAxis(node, m3, M) {
    const compareMinX = node.leaf ? this.compareMinX : compareNodeMinX;
    const compareMinY = node.leaf ? this.compareMinY : compareNodeMinY;
    const xMargin = this._allDistMargin(node, m3, M, compareMinX);
    const yMargin = this._allDistMargin(node, m3, M, compareMinY);
    if (xMargin < yMargin) node.children.sort(compareMinX);
  }
  // total margin of all possible split distributions where each node is at least m full
  _allDistMargin(node, m3, M, compare) {
    node.children.sort(compare);
    const toBBox = this.toBBox;
    const leftBBox = distBBox(node, 0, m3, toBBox);
    const rightBBox = distBBox(node, M - m3, M, toBBox);
  ...
  _condense(path) {
    for (let i2 = path.length - 1, siblings; i2 >= 0; i2--) {
      ...
      } else calcBBox(path[i2], this.toBBox);
    }
  }
};
function findItem(item, items, equalsFn) {
  ...
  for (let i2 = 0; i2 < items.length; i2++) {
    if (equalsFn(item, items[i2])) return i2;
  }
  return -1;
}
...
// src/route_graph_widget.js
var default_width = 800;
var default_height = 500;
var default_repulsion = 80;
...
function render3({ model, el }) {
  ...
  const build_colour_scale = () => {
    ...
    if (feature_type == "numeric") {
      if (colour_scale_type == "diverging") {
        colour_scale = linear2().domain([min(feature_values), 0, max(feature_values)]).range(["#0000FFBF", "white", "#FF0000BF"]);
      } else {
        colour_scale = linear2().domain(extent(feature_values)).range(["#FFFF0080", "#0000FF80"]);
      }
    } else if (feature_type == "hash_string") {
      colour_scale = identity4();
    } else {
      colour_scale = ordinal().domain(extent(feature_values)).range(category10_default);
    }
  };
  ...
  const apply_select_feature = () => {
    select_feature = model.get("select_feature");
    select_feature_value = model.get("select_feature_value");
    if (select_feature && select_feature_value !== void 0 && select_feature_value !== "") {
      local_selected_ids = data.nodes.filter((node) => String(node[select_feature]) === String(select_feature_value)).map((node) => node.id);
    } else {
      local_selected_ids = [];
    }
  ...
  model.on("change:selected_ids", () => {
    ...
    plot.nodeColor(
      (d2) => global_selected_ids.includes(d2.id) ? "red" : local_selected_ids.includes(d2.id) ? "rgba(255,0,0,0.5)" : colour_scale ? colour_scale(d2[colour_feature]) : "#4a4a4a"
    );
  });
  update_repulsion();
  ...
  let activate_brush = () => {
    ...
    overlay.insert("g", ":first-child").attr("id", "brush_group").attr("class", "brush").call(my_brush);
  };
  ...
  let my_brush = brush_default().filter((event) => {
...
function svg_fill(svg, value) {
  ...
  if (typeof value === "string") return value;
  if (Array.isArray(value.stops)) {
    const id2 = `pie-grad-${++gradient_serial}`;
    const gradient = document.createElementNS(SVG_NS, "linearGradient");
    gradient.setAttribute("id", id2);
    value.stops.forEach((color2, index7) => {
      const stop = document.createElementNS(SVG_NS, "stop");
      const offset = value.stops.length === 1 ? 0 : 100 * index7 / (value.stops.length - 1);
...
function pie_slice_path(cx, cy, r2, start_angle, end_angle) {
  const large_arc = end_angle - start_angle > Math.PI ? 1 : 0;
  const x0 = cx + r2 * Math.cos(start_angle);
  const y0 = cy + r2 * Math.sin(start_angle);
  const x1 = cx + r2 * Math.cos(end_angle);
  const y1 = cy + r2 * Math.sin(end_angle);
  return `M ${cx} ${cy} L ${x0} ${y0} A ${r2} ${r2} 0 ${large_arc} 1 ${x1} ${y1} Z`;
}
function build_pie(segments, colors, label) {
  const size = 96;
  const c3 = size / 2;
  const r2 = c3 - 2;
  const total = segments.reduce((sum2, seg) => sum2 + seg.count, 0);
  ...
  if (segments.length === 1) {
    ...
    circle.setAttribute("cx", c3);
    circle.setAttribute("cy", c3);
  ...
  for (const seg of segments) {
    ...
    path.setAttribute("d", pie_slice_path(c3, c3, r2, angle, angle + sweep));
...
function build_counted_card(count, className, inner) {
  ...
  number3.className = "market-count";
  number3.textContent = String(count);
  const card = document.createElement("div");
  card.className = `market-card ${className}`;
  if (inner) {
    card.innerHTML = inner;
  }
  wrap.appendChild(number3);
  wrap.appendChild(card);
  return wrap;
}
function render4({ model, el }) {
...
function renderTickets(model, container) {
  ...
  (frameValue(model, "tickets") || []).forEach((ticket, index7) => {
    ...
    const badge = ticket.status === "completed" ? "DONE" : ticket.status === "cut_off" ? "CUT OFF" : ticket.trainsShort != null ? `OPEN \xB7 ${ticket.trainsShort} to go` : "OPEN";
