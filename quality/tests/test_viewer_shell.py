...
class ViewerShellTests(unittest.TestCase):
    def test_viewer_shell_uses_module_entrypoint(self) -> None:
        html = (REPO_ROOT / "applications" / "viewer" / "index.html").read_text(encoding="utf-8")
        app_jsx = (REPO_ROOT / "applications" / "viewer" / "app.jsx").read_text(encoding="utf-8")
        replay_app = (REPO_ROOT / "applications" / "viewer" / "components" / "replay-app.jsx").read_text(encoding="utf-8")
        replay_dashboard = (
            REPO_ROOT / "applications" / "viewer" / "components" / "dashboard" / "ReplayDashboard.jsx"
        ).read_text(encoding="utf-8")
        bots_dashboard = (
            REPO_ROOT / "applications" / "viewer" / "components" / "dashboard" / "BotsDashboard.jsx"
        ).read_text(encoding="utf-8")
        sidebar = (
            REPO_ROOT / "applications" / "viewer" / "components" / "layout" / "Sidebar.jsx"
        ).read_text(encoding="utf-8")
        bot_registry_service = (
            REPO_ROOT / "applications" / "viewer" / "components" / "services" / "bot-registry.jsx"
        ).read_text(encoding="utf-8")
        map_routes_panel = (
            REPO_ROOT / "applications" / "viewer" / "components" / "panels" / "map-routes" / "MapRoutesPanel.jsx"
        ).read_text(encoding="utf-8")
        match_sidebar_panel = (
            REPO_ROOT / "applications" / "viewer" / "components" / "panels" / "match-sidebar" / "MatchSidebarPanel.jsx"
        ).read_text(encoding="utf-8")
        replay_model = (
            REPO_ROOT / "applications" / "viewer" / "components" / "model" / "replay-model.jsx"
        ).read_text(encoding="utf-8")
        constants = (
            REPO_ROOT / "applications" / "viewer" / "components" / "constants.jsx"
        ).read_text(encoding="utf-8")
        route_service = (
            REPO_ROOT / "applications" / "viewer" / "components" / "services" / "route-svg.jsx"
        ).read_text(encoding="utf-8")
        ...
        self.assertIn("Discover local bots and connections", sidebar)
    ...
    def test_active_viewer_component_imports_do_not_reference_js_modules(self) -> None:
        viewer_root = REPO_ROOT / "applications" / "viewer"
    ...
    def test_active_viewer_readme_documents_first_party_structure(self) -> None:
        viewer_readme = (REPO_ROOT / "applications" / "viewer" / "README.md").read_text(encoding="utf-8")
